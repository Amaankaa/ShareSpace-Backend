...
func (s *ResourceControllerTestSuite) SetupTest() {
	...
	s.router.GET("/users/:userId/resources", s.controller.GetUserResources)
	s.router.GET("/users/:userId/resources/liked", s.controller.GetUserLikedResources)
	s.router.GET("/users/:userId/resources/bookmarked", s.controller.GetUserBookmarkedResources)
	s.router.GET("/resources/:id/analytics", s.controller.GetResourceAnalytics)
	s.router.GET("/users/:userId/resources/stats", s.controller.GetUserResourceStats)
